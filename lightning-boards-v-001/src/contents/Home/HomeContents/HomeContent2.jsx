...
function HomeContent2(props) {
    return(
        <div>
            ...
            <div className='row content2' style={{padding: '50px'}}>
                <div className='column text-center' style={{maxWidth: '40%', display: 'block', marginTop: 'auto', marginBottom: 'auto', height: '200px', borderRight: '3px solid #F4A442'}}>
                ...
                <div className='column' style={{maxWidth: '60%', paddingLeft: '50px'}}>
                    <div className='row'>
